...
CTOR_OPS = {'dynamic_array': {'new': lambda a: True}, 'deque': {'new': lambda a: True}, 'queue': {'new': lambda a: True}, 'doubly_linked_list': {'new': lambda a: True}, 'binary_heap': {'new': lambda a: True}, 'balanced_search_tree': {'new': lambda a: True}, 'bitset': {'new': lambda a: True}}
