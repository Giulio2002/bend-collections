#!/usr/bin/env python3
"""Generate the hash map invariant (proofs/hash_table/state.bend, between the
free-list comment and the slot-value section) and its rebuild lemmas
(proofs/hash_table/rebuild.bend).
...
STATE = ROOT / "proofs/hash_table/state.bend"
REBUILD = ROOT / "proofs/hash_table/rebuild.bend"
