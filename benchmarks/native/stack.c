/* User-requested native-list stack algorithm; selectors, RNG and checksums retained. */
#include "stack.h"
#define NULL_OP 99u

static uint32_t round_stack(uint32_t op, uint32_t size, uint32_t count,
